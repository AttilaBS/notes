<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
 @vite(['resources/scss/app.scss', 'resources/js/app.js'])
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16 not-hidden flex-align-center">
            <div class="flex">
                <!-- Logo -->
            ...
            <div class="dropdown-menu sm:flex sm:items-center sm:ml-6">
                <!-- Teams Dropdown -->
            ...
            <!-- Hamburger -->
            <div class="-mr-2 flex items-center md:hidden hamburger">
