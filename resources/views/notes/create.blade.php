...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        ...
        <div class="min-h-screen bg-gray-100">
            ...
            @endisset
            <!-- Page Content -->
            <main class="background-edit">
                <div class="z-10 inset-0 overflow-y-auto ease-out duration-400 modal-notes">
                            ...
                            <form action="{{ route('notes.store') }}" method="post">
                                ...
                                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                    <div class="">
                                        ...
                                        <input type="text" name="title" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Título" value="{{ request('title', old('title')) }}">
                                        @error('title')
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea name="content" class="whitespace-pre-line shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                                            {{ request('content', old('content')) }}
                                        </textarea>
                                        @error('content')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
